                ...
                <div class="col-12">
                    {!! Form::model($item, $formAttributes) !!}
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        {!! Form::select("category", $category, $relationships, ["class" => "form-control select2", "id" => "category", "data-placeholder" => "Select Category", "required" => true]) !!}
                                    </div>
                                    @error('category')
                                        <span class="invalid-feedback d-block" role="alert">
                                            <strong>{{ $message }}</strong>
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        {!! Form::select("brand", $brands, $relationships, ["class" => "form-control select2", "id" => "brand", "data-placeholder" => "Select Brand", "required" => true]) !!}
                                    </div>
                                    @error('brand')
                                        <span class="invalid-feedback d-block" role="alert">
                                            <strong>{{ $message }}</strong>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                {!! Form::select("ingredients[]", $ingredients, $relationships, ["class" => "form-control select2", "id" => "ingredients", "data-placeholder" => "Select Ingredients", "multiple" => true, "required" => true]) !!}
                            </div>
                            @error('ingredients')
                                <span class="invalid-feedback d-block" role="alert">
                                    <strong>{{ $message }}</strong>
