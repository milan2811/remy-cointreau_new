    ...
    @if (!$item || empty($selectedBrandsCates))
        <div class="row">
            ...
            <div class="col-4 brands">
                <div class="form-group">
                    <div class="input-group">
                        {!! Form::select('ingredient_category[brand][]', $remy_brands, null, ['class' => 'form-control custom-select2 parent-brand', 'placeholder' => 'Select Brand', 'disabled' => request()->has('analytics') && request()->get('analytics')]) !!}
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                ...
                @if (isset($selectedBrandsCate[1]))
                    <div class="col-4 brands">
                        <div class="form-group">
                            <div class="input-group">
                                {!! Form::select('ingredient_category[brand][]', $item->drink_id == 42 ? $brands : $remy_brands, $selectedBrandsCate[1]->id, ['class' => 'form-control custom-select2 parent-brand', 'placeholder' => 'Select Brand', 'disabled' => request()->has('analytics') && request()->get('analytics')]) !!}
                            </div>
                        </div>
                    </div>
                @else
                    <div class="col-4 brands">
                        <div class="form-group">
                            <div class="input-group">
                                {!! Form::select('ingredient_category[brand][]', $item->drink_id == 42 ? $brands : $remy_brands, null, ['class' => 'form-control custom-select2 parent-brand', 'placeholder' => 'Select Brand', 'disabled' => request()->has('analytics') && request()->get('analytics')]) !!}
                            </div>
                        </div>
                    </div>
                @endif                
...
@section('scripts')
    <script>
        ...
        const liquorBrands = JSON.parse('{!! json_encode($remy_brands) !!}');        
