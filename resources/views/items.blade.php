...
@section('content')
    ...
    <x-app-banner :bar="isset($bar)? $bar : null" :title="(isset($category->name)? $category->name : 'Title here')"></x-app-banner>
                            ...
                            @if (isset($items) && !empty($items))
                                <div class="best-seller">
                                    <div class="best-items">
                                        @if (isset($feature_items) && $feature_items) 
                    ...
                    <div class="category-section section-row">
                        <div class="wrap">
                            ...
                            <div class="category-boxes">
                                ...
                                @endphp --}}
                                    <x-app-category-card :category="$drink" :background="$drink->background_color" :bar="(isset($bar) ? $bar : null)"></x-app-category-card>
                                @endforeach
                            </div>
                        </div>
                    </div>
