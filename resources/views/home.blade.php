...
@section('content')
    ...
    <x-app-banner :bar="isset($bar) ? $bar : null"></x-app-banner>

    <div id="main">
        <div id="primary" class="content-area one-column">
            <div id="content" class="site-content">
                <x-app-search></x-app-search>
                @if (isset($drinks) && !empty($drinks) && count($drinks))
                        ...
                        <div class="wrap">
                            ...
                            <div class="category-boxes">
                                ...
                                @foreach ($drinks as $drink)                                   
                                    <x-app-category-card :category="$drink" :background="$drink->background_color"
