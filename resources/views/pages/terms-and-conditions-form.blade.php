...
@section('content')
    ...
    <div class="content">
        <div class="container-fluid">
            {!! Form::model($home, ['url' => route('page.update', 'terms-and-conditions'), 'class' => 'repeater', 'method' => 'POST', 'files' => true]) !!}
            <div class="row">
                <div class="col-12">
                    {{-- Page Content --}}
                            ...
                            <div id="banner-collapse" class="collapse" aria-labelledby="banner-heading"
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        {!! Form::label('page_content', 'Text Content') !!}
                                        <div class="input-group">
                                            {!! Form::textarea('page_content', null, ['class' => 'form-control summernote-description', 'id' => 'page-content']) !!}
                                        </div>
                                    </div>                                    
                                </div>
                            </div>
