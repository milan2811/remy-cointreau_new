          ...
          <div class="card">
            <div class="card-header">
              <div class="row mb-2 justify-content-between">
                ...
                <div class="col-sm-2">
                  <a href="<?php echo e(route('region.create')); ?>" class="btn btn-block btn-outline-primary">Create region</a>
                </div>
              </div>              
            ...
            <!-- /.card-header -->
            <div class="card-body">
              <table id="region-table" class="table table-bordered table-hover" style="width: 100%;">
                <thead>
                  <tr>
                    <th>#</th>
                    <th>Title</th>
...
<?php $__env->startSection('scripts'); ?>
  <script>
    $(function() {
      ...
      var dataTable = $('#region-table').DataTable({
        ...
        ajax: {
          ...
          url: "<?php echo route('get.regions'); ?>",
          data: function(d) {
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/admin/web/64.4.160.99/public_html/remy-cointreau/resources/views/region/index.blade.php ENDPATH**/ ?>