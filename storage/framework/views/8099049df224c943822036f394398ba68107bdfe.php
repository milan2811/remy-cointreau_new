...
unset($__errorArgs, $__bag); ?>
                        ...
                        <?php if(auth()->user()->id == ($user ? $user->id : false) || $user == NULL): ?>
                            <div class="form-group">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/admin/web/64.4.160.99/public_html/remy-cointreau/resources/views/user-form.blade.php ENDPATH**/ ?>