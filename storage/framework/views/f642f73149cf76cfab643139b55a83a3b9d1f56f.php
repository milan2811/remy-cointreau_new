            ...
            <div class="card-header">
              <div class="row mb-4">
                <div class="col-12 text-right">                  
                  <a href="<?php echo e(route('items.create')); ?>?bar=<?php echo e($selectedBar); ?>" class="btn  btn-outline-primary">Add Item</a>
                  <?php if(auth()->user()->role_id > 4): ?>
                    <a href="<?php echo e(route('request.create')); ?>?bar=<?php echo e($selectedBar); ?>" class="btn btn-outline-primary">Request Term</a>
                  <?php endif; ?>                  
                </div>
              </div>
              <div class="row mb-2">
      ...
      var dataTable = $('#items-table').DataTable({
        ...
        ajax: {
          ...
          data: function(d) {
            ...
            d.bar_id = '<?php echo e(request()->has("bar") ? request()->get("bar") :  null); ?>'
          },
          type: 'post'
        },
        columns: [{
