...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>">
    ...
    <body class="antialiased">
        ...
        <footer class="main-footer">
            <p class="text-right m-0">powered by
                <a href="https://froztech.com" target="_blank" class="text-dark">
                    <img src="<?php echo e(asset('public/images/froztech_dark.png')); ?>" alt="froztech">
                </a>
            </p>
        </footer>
    </body>
</html>
<?php /**PATH /home/admin/web/64.4.160.99/public_html/remy-cointreau/resources/views/welcome.blade.php ENDPATH**/ ?>