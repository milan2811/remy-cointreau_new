          ...
          <div class="card">
            <div class="card-header">
              <div class="row mb-2 justify-content-between">
                ...
                <div class="col-sm-2">
                  <a href="<?php echo e(route('bars.create')); ?>" class="btn btn-block btn-outline-primary">Add New</a>
                </div>
              </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/admin/web/64.4.160.99/public_html/remy-cointreau/resources/views/bars.blade.php ENDPATH**/ ?>