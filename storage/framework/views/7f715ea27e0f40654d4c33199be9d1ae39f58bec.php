            ...
            <div class="row">
                <?php if(isset($bars) && !empty($bars)): ?>
                    <div class="col-lg-3 col-6">
                        <!-- small box -->
                        <a href="<?php echo e(route('bars.index')); ?>" style="text-decoration: none;">
                            <div class="small-box bg-info">
                                <div class="inner">
                                    <h3><?php echo e($bars); ?></h3>
                ...
                <?php if(isset($category) && !empty($category)): ?>
                    <div class="col-lg-3 col-6">
                        <!-- small box -->
                        <a href="<?php if(auth()->user()->role_id < 5): ?> <?php echo e(route('category.index')); ?> <?php else: ?> Javascript:; <?php endif; ?>"
                ...
                <?php if(isset($ingredients) && !empty($ingredients)): ?>
                    <div class="col-lg-3 col-6">
                        <!-- small box -->
                        <a href="<?php if(auth()->user()->role_id < 5): ?> <?php echo e(route('ingredients.index')); ?> <?php else: ?> Javascript:; <?php endif; ?>"
                           style="text-decoration: none;">
                            <div class="small-box bg-warning">
                                <div class="inner">
                                    <h3><?php echo e($ingredients); ?></h3>
                ...
                <?php if(isset($brands) && !empty($brands)): ?>
                    <div class="col-lg-3 col-6">
                        <!-- small box -->
                        <a href="<?php if(auth()->user()->role_id < 5): ?> <?php echo e(route('brands.index')); ?> <?php else: ?> Javascript:; <?php endif; ?>"
                           style="text-decoration: none;">
                            <div class="small-box bg-danger">
                                <div class="inner">
                                    <h3><?php echo e($brands); ?></h3>
                                    <p>Brands</p>
                                </div>
                                <div class="icon">
                                    <i class="fas fa-copy"></i>
